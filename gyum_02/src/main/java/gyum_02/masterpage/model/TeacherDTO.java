...
public class TeacherDTO {
	...
	public TeacherDTO(int tea_idx, String tea_id, String tea_pwd, int pwd_q_idx, String tea_pwd_a, int tea_birth,
			String tea_name, String tea_tel, String tea_email, int subject_num, Date tea_in_date, Date tea_out_date,
			int file_idx) {
		super();
