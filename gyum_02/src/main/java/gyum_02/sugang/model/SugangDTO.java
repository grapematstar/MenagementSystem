...
public class SugangDTO {
	...
	private int class_idx; // 과목 idx
	private int subject_num; //과목 번호
	private int class_startdate; // 강의시작일
	private int class_enddate; // 강의종료일
	private int classroom; // 강의실
	private String class_day; // 강의요일
	private int class_time; // 강의시간
	private String class_subject; // 과목명
	private String tea_name; //선생님 이름
	private int class_price; // 수강료
	private int class_max_student; // 최대정원수
