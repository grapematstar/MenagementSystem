...
public class My_memberParentDTO {
	...
	public My_memberParentDTO() {
		super();
	}
	public My_memberParentDTO(int par_idx, String par_id, String par_pwd, int pwd_q_idx, String par_pwd_a,
			String par_name, String par_tel, String par_email, Date par_in_date) {
		super();
