...
public class My_memberClassDTO {
	...
	public My_memberClassDTO() {
		super();
	}
	public My_memberClassDTO(int class_idx, int subject_num, int class_startdate, int class_enddate, int classroom,
