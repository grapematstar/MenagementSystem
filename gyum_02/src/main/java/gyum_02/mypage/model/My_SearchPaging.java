...
public class My_SearchPaging {
	public static String searchPaging(String pageName, int totalCnt, int listSize, int pageSize, int cp, Map<String,Object> searchMap) {
		...
		if (userGroup != (totalPage / pageSize - (totalPage % pageSize == 0 ? 1 : 0))) {
			...
			sb.append(temp);
			sb.append("'>&gt;</a></li>");
			sb.append("<li class=\"paginate_button next\"><a href='"+pageName+"?cp="+totalPage+"'>?걹?럹?씠吏?</a></li></ul>");
		}else{
	...
	public static String searchPagingForAjax(String pageName, int totalCnt, int listSize, int pageSize, int cp) {
		...
		if (userGroup != (totalPage / pageSize - (totalPage % pageSize == 0 ? 1 : 0))) {
			...
			sb.append(temp);
			sb.append(")'>&gt;</a></li>");
			sb.append("<li class=\"paginate_button next\"><a href='javascript:"+pageName+"("+totalPage+")'>?걹?럹?씠吏?</a></li></ul>");
		}else{
			sb.append("<li class=\"paginate_button next disabled\"><a href='#'>끝페이지</a></li></ul>");
		}
		return sb.toString();
	}
	public static String searchPagingMapAjax(String pageName, int totalCnt, int listSize, int pageSize, int cp,List<String> checkList, Map<String,Object> searchMap) {
