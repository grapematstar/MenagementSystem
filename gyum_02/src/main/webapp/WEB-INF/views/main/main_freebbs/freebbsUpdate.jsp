...
<section id="update">
	<form name="freebbsWrite" id="freebbsWrite" action="freebbsWrite.do" method="post">
		<span id="subdiv">			
			<input type="hidden" id="f_b_idx" name="f_b_idx" value="${dto.f_b_idx}">
			<input type="hidden" id="f_b_writer" name="f_b_writer" value="${dto.f_b_writer}">
			<span id="je">제목 | </span><span id="jetext"><input type="text" id="f_b_subject" name="f_b_subject" value="${dto.f_b_subject}"></span>
		</span>
		<div id="writediv" class="col-md-12 col-sm-12 col-xs-12 mail-reply">
           	<textarea class="summernote" name="f_b_content" id="f_b_content">${dto.f_b_content}</textarea>
