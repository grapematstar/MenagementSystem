	...
	<table id="noticetable" width="600" border="1" cellspacing="0" class="table-striped table-bordered dataTable no-footer">
		...
		<tbody>
			...
			<c:forEach var="dto" items="${list}">
				<tr>
					<c:url var="contentUrl" value="t_n_UpdateGo.do">
						<c:param name="idx" value="${dto.t_n_idx}" />
					</c:url>
					<td align="center">${dto.t_n_idx}</td>
					<td id="notsub"><a href="${contentUrl}">${dto.t_n_subject}</a></td>
					<td align="center">${dto.t_n_writedate}</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
