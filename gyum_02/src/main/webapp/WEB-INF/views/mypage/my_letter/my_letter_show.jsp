...
<table class="table table-hover">
	...
	<tfoot>
		<tr>
			<td style="text-align:left;"><a href="open_letter_box.do">목록</a></td>
			<td colspan="3" style="text-align:right;">
			<c:if test="${letter.letter_sender != 'master' }">
				<a href="write_letter_back.do?letter_sender=${letter.letter_sender }">답장</a>
			</c:if>
			</td>
		</tr>
	</tfoot>
