...
function idCheck(){
	...
	params.tea_id=document.getElementById("tea_id").value;
	var idReg = /^[a-z]+[a-z0-9]{5,19}$/g;
    if( !idReg.test( $("input[name=tea_id]").val() ) ) {
            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form id="example1" name="stu_write" action="teacherWrite.do" method="post"  enctype="multipart/form-data">
                            <h3>Account</h3>
                            <fieldset>
                                <legend>Account Information</legend>
                                <label for="userName-2">아이디</label><br>
                                <input id="tea_id" name="tea_id" type="text" class="required" value="${tea_id}">
                                <input type="button" value="중복 확인" onclick="idCheck()"><br>
                                <label for="surname-2">이름</label>
                                <input id="surname-2" name="tea_name" type="text" class="required">
                                <label for="password-2" id="tea_pwd_q">비밀 번호</label>
                                <label for="password-2" id="tea_q">비밀 번호 확인</label><br>
                                <input id="pwd1" name="tea_pwd" type="password" class="required">                          
                                <input id="pwd2" name="tea_pwd" type="password" onkeyup="compare()" class="required">
								...
								<input name="tea_pwd_a" type="text" class="required">       
                            </fieldset>
                            ...
                            <fieldset>
                                ...
                                <input id="email-3" name="tea_email" type="text" class="required email"><input type="button" id="email-4" class=" btn btn-raised btn-primary" value="이메일 인증" onclick="emailCheck()"><label id="label_email"></label><br/><br/>
                                <label for="address-2">생년월일</label>
                                <input id="cal_1" name="tea_birth" type="text">
                               	<label for="tel-2">전화번호</label>
                                <input type="number" name="tea_tel">
