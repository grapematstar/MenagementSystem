...
<script>
function submitON(){
	var stu_birthnum = new Array();
	stu_birthnum = document.getElementById("cal_1").value;
	var stu_birth = stu_birthnum.replace(/-/g,'');
	document.getElementById("cal_1").value = stu_birth;

	var formID=document.getElementById('stu_Write');
...
function idCheck(){
	...
	params.stu_id=document.getElementById("stu_id").value;
	var idReg = /^[a-z]+[a-z0-9]{5,19}$/g;
    if( !idReg.test( $("input[name=stu_id]").val() ) ) {
...
function emailCheck(){
	...
	window.open("emailAuth.do?email="+email,"new","width=350,height=450");
}
</script>
</head>
            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form id="example1" name="stu_write" action="studentWrite.do" method="post"  enctype="multipart/form-data">
                            <h3>Account</h3>
                            <fieldset>
                                <legend>Account Information</legend>
                                <label for="userName-2">아이디</label><br>
                                <input id="stu_id" name="stu_id" type="text" class="required" value="${stu_id}">
                                <input type="button" class="btn btn-raised btn-primary" value="중복 확인" onclick="idCheck()"><br>
                                <label for="surname-2">이름</label>
                                <input id="surname-2" name="stu_name" type="text" class="required">
                                <label for="password-2" id="stu_pwd_q">비밀 번호</label>
                                <label for="password-2" id="stu_q">비밀 번호 확인</label><br>
                                <input id="pwd1" name="stu_pwd" type="password" class="required">                          
                                <input id="pwd2"type="password" onkeyup="compare()" class="required">
                                <label id="pwdCheckText"></label><br><br>
								...
								<input name="stu_pwd_a" type="text" class="required">       
                            </fieldset>
                            ...
                            <fieldset>
                                ...
                                <input id="email-3" name="stu_email" type="text" class="required email"><input type="button" id="email-4" class=" btn btn-raised btn-primary" value="이메일 인증" onclick="emailCheck()"><label id="label_email"></label><br/><br/><br/>
                                <label for="address-2">생년월일</label>
                                <input id="cal_1" name="stu_birth" type="text">
                               	<label for="tel-2">전화번호</label>
                                <input type="number" name="stu_tel">
                               	<label for="tel-2">학교</label>
                                <input type="text" name="stu_school">
                               	<label for="tel-2">학년</label>
                                <input type="number" name="stu_grade">
