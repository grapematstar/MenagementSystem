...
function makestudy_inq_list(inql){	
	...
	if(inql.stu_id=="${sessionScope.id}"){		
		...
		inqldiv.innerHTML='<table cellspacing=0 width=850><td style="min-width:100px;"></td><td width="10" style="text-align:right;padding-bottom:0px;"></td><td style="min-width:10px;text-align:right !important;">'+inql.study_inq_readcheck+'<span class="inq_" style="text-align:right;">'+inql.study_inq_content+'</span></td></tr></table>';	
	}else{
		inqldiv.setAttribute('id','inq');
		inqldiv.innerHTML='<table cellspacing="0" width=833><tr><td style="min-width:10px;text-align:left !important;"><span class="req_">'+inql.study_inq_content+'</span></td><td ></td><td style="min-width:100px;"></td></tr></table>';	
	}		
	i++;
...
function inq_yadd(){
	var study_inq_content=document.getElementById('study_inq_content').value;
	var study_idx=${inqdto.study_idx};
	var study_recruitidx=${inqdto.study_recruitidx};
	var study_inq_reciver="${inqdto.study_inq_reciver}";
	var study_inq_sender="${inqdto.study_inq_sender}";
...
<body id="mimin" class="dashboard" onload="inq_recive_list()" style="width:1200px;" >
