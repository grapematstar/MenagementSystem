					...
					<div class="col-md-12 col-sm-12">
						...
						<div class="panel-body">
							...
							<div class="responsive-table">
							       <form name="QnAWrite" action="cc_submitQnAWrite.do" method="POST">
<table width="100%">
	<thead>
		<tr>
			<th>제목</th><td><input type="text" name="c_q_q_subject" id="c_q_q_subject"></td>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td colspan="2"><textarea id="c_q_q_content" name="c_q_q_content"></textarea></td>
		</tr>
	</tbody>
	<tfoot>
	</tfoot>
