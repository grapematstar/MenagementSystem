...
<form name="QnAUpdate" action="cc_submitQnAUpdate.do" method="POST">
<input type="hidden" name="c_q_q_idx" id="c_q_q_idx" value="${dto.c_q_q_idx}">
<table>
	<thead>
		<tr>
			<th>작성날짜</th><td>${dto.c_q_q_writedate}</td>
			<th>글쓴이</th><td>${dto.c_q_q_writer}</td>
			<th>제목</th><td><input type="text" name="c_q_q_subject" value="${dto.c_q_q_subject}"></td>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td colspan="3"><textarea name="c_q_q_content">${dto.c_q_q_content}</textarea></td>
		</tr>
	</tbody>
	<tfoot>
	</tfoot>
