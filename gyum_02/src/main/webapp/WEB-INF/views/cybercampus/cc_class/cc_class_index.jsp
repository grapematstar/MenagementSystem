												...
												<table class="table table-hover" style="width:100%">
														...
														<tbody>
															...
															<tr>
																...
																<td><div class="hidelongsentence"><a href="cc_gotoFreeBBSContent.do?c_f_b_idx=${c_f_b_idx}" data-toggle="tooltip" data-placement="top" title="${freeList.string_writedate}">${freeList.c_f_b_subject}</a></div></td>
