...
<!-- 강의계획작성버튼:작성이 되어있을 경우에는 수정버튼만 보이게 -->
<div style="text-align:right;">
<c:if test="${empty dataMap.dto}">
<input type="button" class="btn btn-primary" onclick="location.href='cc_gotoInfoPlanWrite.do'" value="작성">
</c:if>
<c:if test="${!empty dataMap.dto}">
<input type="button" class="btn btn-primary" onclick="location.href='cc_gotoInfoPlanUpdate.do'" value="수정">
</c:if>
</div>
							</div>
							</div>
