...
<table class="table table-striped table-bordered">
	<thead>
		<tr>
			<th>작성날짜</th><td>${dto.string_writedate}</td>
		</tr>
		<tr>
			<th>글쓴이</th><td>${dto.t_n_writer}</td>
		</tr>
		<tr>
			<th>제목</th><td>${dto.t_n_subject}</td>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td colspan="4">${dto.t_n_content}</td>
		</tr>
	</tbody>
	<tfoot>
	</tfoot>
</table>
<div style="text-align:right;"><input type="button" value="뒤로" class="btn btn-default" onclick="history.back(-1)"></div>
