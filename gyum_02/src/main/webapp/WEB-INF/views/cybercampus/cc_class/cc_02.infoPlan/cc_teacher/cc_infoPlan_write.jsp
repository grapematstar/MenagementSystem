...
강의명: <div><span>${class_subject}</span></div>
<input type="hidden" name="club_idx" id="club_idx" value="${club_idx}">
과목: <div><span>${sessionScope.classInfo.class_num}</span></div>
<input type="hidden" name="subject_num" id="subject_num" value="${subject_num}">
강의개요<br>
<textarea name="c_i_p_overview" id="c_i_p_overview" rows="3" cols="100" required></textarea><br>
강의목표<br>
<textarea name="c_i_p_purpose" id="c_i_p_purpose" rows="3" cols="100" required></textarea><br>
<hr>
강의계획<br>
<fieldset>
<div style="display:none;">
<div id="PlanUNIT">
<div>단원: <input type="number" name="c_plan_unit" value="1">
세부계획: <textarea name="c_plan_content"></textarea></div>
<input type="button" value="삭제"></div>
</div>

<input type="button" id="submitInfoPlanWrite" value="등록">
...
$(document).ready(function(){
	...
	$("#addPlanUNIT").click(function(){
		...
		$("#PlanUnit"+idNum+" > input[name='c_plan_unit']").val(idNum);
	});
