...
<form name="cc_submitNoticeUpdate" action="cc_submitNoticeUpdate.do" method="POST">
<table>
	<thead>
		<tr>
			...
			<th>제목</th><td><input type="text" name="c_n_subject" value="${dto.c_n_subject}"></td>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td colspan="2"><textarea name="c_n_content" cols="100" rows="20">${dto.c_n_content}</textarea></td>
		</tr>
	</tbody>
	<tfoot>
	</tfoot>
</table>
<input type="hidden" name="c_n_idx" value="${dto.c_n_idx}">
<input type="file" name="c_n_file~~~~~***">
<hr>
<input type="submit" value="수정">
<input type="button" value="삭제" onclick="location.href='cc_submitNoticeDelete.do?c_n_idx=${dto.c_n_idx}'">
