(function ($) {
    ...
    this.leftMenu =  function()
    {
         ...
         $('.opener-left-menu').on('click', function(){
            ...
            if( $('#left-menu .sub-left-menu').is(':visible') ) {
                ...
                $('#left-menu .sub-left-menu').animate({ 'width': '200px' }, 'slow');
                $('#content').animate({ 'padding-left': '200px','padding-right':'0px'}, 'slow');
                $('.overlay').hide();
    ...
    this.rightMenu =  function(){
            ...
            if($('#right-menu').is(':visible') ) {
                ...
                $('#right-menu').show();
                $('#right-menu').animate({ 'width': '200px' }, 'slow');
                $('#content').animate({ 'padding-right': '200px'}, 'slow');
            }
        });
    };
